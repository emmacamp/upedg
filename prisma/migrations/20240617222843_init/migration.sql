...
CREATE TABLE "meetings" (
    ...
    CONSTRAINT "meetings_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "courses" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "meetings_courseId_key" ON "meetings"("courseId");
